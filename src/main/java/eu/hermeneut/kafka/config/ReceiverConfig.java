...
public class ReceiverConfig {
    ...
    public ConsumerFactory<String, RiskProfile> consumerFactory() {
        //https://stackoverflow.com/questions/50268124/spring-boot-kafka-json-deserialization-trusted-packages
        return new DefaultKafkaConsumerFactory<>(consumerConfigs(),
            new StringDeserializer(),
            new JsonDeserializer(RiskProfile.class, new ObjectMapper()
                )
        );
    }
