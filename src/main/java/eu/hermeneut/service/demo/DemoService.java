...
package eu.hermeneut.service.demo;
...
public interface DemoService {
    ...
    boolean loadService(User user, CompanyProfile companyProfile);

    boolean loadGDPR(User currentUser, CompanyProfile companyProfile);
}
