...
public interface DataRiskCalculator {
    OverallDataRisk calculateOverallDataRisk(OverallSecurityImpact overallSecurityImpact, OverallDataThreat overallDataThreat);
}
