...
public class EconomicResults implements Serializable {
    ...
    @Column(name = "economic_performance", precision=50, scale=2)
    private BigDecimal economicPerformance;

    @Column(name = "intangible_driving_earnings", precision=50, scale=2)
    private BigDecimal intangibleDrivingEarnings;

    @Column(name = "intangible_capital", precision=50, scale=2)
    private BigDecimal intangibleCapital;

    @Column(name = "intangible_loss_by_attacks", precision=50, scale=2)
