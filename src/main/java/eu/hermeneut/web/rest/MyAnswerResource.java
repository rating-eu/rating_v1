...
public class MyAnswerResource {
    ...
    @Timed
    public ResponseEntity<MyAnswer> createMyAnswer(@Valid @RequestBody MyAnswer myAnswer) throws URISyntaxException {
    ...
    @Timed
    public ResponseEntity<MyAnswer> updateMyAnswer(@Valid @RequestBody MyAnswer myAnswer) throws URISyntaxException {
