            ...
            (params: Params) => {
                ...
                this.myAssetService.find(assetId).toPromise().then((asset) => {
                    if (asset.body) {
                        ...
                        this.threatAgentInterestService.getThreatAgentsInterestsByCompanyProfileAndMyAsset(this.myCompany.companyProfile, this.selectedAsset).toPromise().then((res) => {
                            if (res) {
