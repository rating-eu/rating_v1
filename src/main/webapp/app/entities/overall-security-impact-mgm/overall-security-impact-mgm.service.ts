...
export class OverallSecurityImpactMgmService {
    ...
    private resourceUrlByCompanyProfile = SERVER_API_URL + 'api/overall-security-impacts/company-profile/' + COMPANY_PLACEHOLDER;
    ...
    getAllByCompanyProfile(companyID: number): Observable<HttpResponse<OverallSecurityImpactMgm[]>> {
