...
const QUESTION_TYPE_PLACEHOLDER = '{questionTyoe}';

@Injectable()
export class AnswerWeightMgmService {

    private resourceUrl = SERVER_API_URL + 'api/answer-weights';
    private byQuestionTypeUrl = this.resourceUrl + '/type/' + QUESTION_TYPE_PLACEHOLDER;
    ...
    findAllByQuestionType(type: QuestionType): Observable<HttpResponse<AnswerWeightMgm[]>> {
        return this.http.get<AnswerWeightMgm[]>(this.byQuestionTypeUrl
            .replace(QUESTION_TYPE_PLACEHOLDER, QuestionType[type]), {observe: 'response'})
