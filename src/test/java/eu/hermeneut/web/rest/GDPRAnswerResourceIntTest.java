...
public class GDPRAnswerResourceIntTest {
    ...
    private static final DataImpact DEFAULT_DATA_IMPACT = DataImpact.LOW;
    private static final DataImpact UPDATED_DATA_IMPACT = DataImpact.MEDIUM;
    ...
    public static GDPRAnswer createEntity(EntityManager em) {
        GDPRAnswer gDPRAnswer = new GDPRAnswer()
            ...
            .dataImpact(DEFAULT_DATA_IMPACT)
            .order(DEFAULT_ORDER);
        return gDPRAnswer;
    }
    ...
    public void createGDPRAnswer() throws Exception {
        ...
        assertThat(testGDPRAnswer.getDataImpact()).isEqualTo(DEFAULT_DATA_IMPACT);
    ...
    public void getAllGDPRAnswers() throws Exception {
        ...
        restGDPRAnswerMockMvc.perform(get("/api/gdpr-answers?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].dataImpact").value(hasItem(DEFAULT_DATA_IMPACT.toString())))
    ...
    public void getGDPRAnswer() throws Exception {
        ...
        restGDPRAnswerMockMvc.perform(get("/api/gdpr-answers/{id}", gDPRAnswer.getId()))
            ...
            .andExpect(jsonPath("$.dataImpact").value(DEFAULT_DATA_IMPACT.toString()))
    ...
    public void updateGDPRAnswer() throws Exception {
        ...
        updatedGDPRAnswer
            ...
            .dataImpact(UPDATED_DATA_IMPACT)
            .order(UPDATED_ORDER);
        ...
        assertThat(testGDPRAnswer.getDataImpact()).isEqualTo(UPDATED_DATA_IMPACT);
