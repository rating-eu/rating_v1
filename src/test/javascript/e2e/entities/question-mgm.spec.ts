...
describe('Question e2e test', () => {
    ...
    it('should create and save Questions', () => {
        ...
        // questionDialogPage.areasSelectLastOption();
...
export class QuestionDialogPage {
    ...
    areasSelect = element(by.css('select#field_areas'));
    ...
    areasSelectLastOption = function() {
        this.areasSelect.all(by.tagName('option')).last().click();
    };

    areasSelectOption = function(option) {
        this.areasSelect.sendKeys(option);
    };

    getAreasSelect = function() {
        return this.areasSelect;
    };

    getAreasSelectedOption = function() {
        return this.areasSelect.element(by.css('option:checked')).getText();
    };
