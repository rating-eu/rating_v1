...
describe('Service Tests', () => {
    ...
    describe('ExternalAuditMgm Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ExternalAuditMgmService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/external-audits';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ExternalAuditMgm', () => {
