...
describe('Service Tests', () => {
    ...
    describe('SystemConfigMgm Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(SystemConfigMgmService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/system-configs';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return SystemConfigMgm', () => {
