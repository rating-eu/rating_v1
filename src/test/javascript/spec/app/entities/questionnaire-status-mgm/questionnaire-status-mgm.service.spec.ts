...
describe('Service Tests', () => {
    ...
    describe('QuestionnaireStatusMgm Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(QuestionnaireStatusMgmService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/questionnaire-statuses';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return QuestionnaireStatusMgm', () => {
