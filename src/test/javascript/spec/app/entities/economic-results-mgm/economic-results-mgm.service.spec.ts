...
describe('Service Tests', () => {
    ...
    describe('EconomicResultsMgm Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(EconomicResultsMgmService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/economic-results';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return EconomicResultsMgm', () => {
