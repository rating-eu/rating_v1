...
describe('Service Tests', () => {
    ...
    describe('AttackStrategyMgm Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(AttackStrategyMgmService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/attack-strategies';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return AttackStrategyMgm', () => {
