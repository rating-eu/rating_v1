...
describe('Service Tests', () => {
    ...
    describe('ImpactLevelMgm Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ImpactLevelMgmService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/impact-levels';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ImpactLevelMgm', () => {
