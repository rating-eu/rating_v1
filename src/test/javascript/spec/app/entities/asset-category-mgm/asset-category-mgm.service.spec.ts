...
describe('Service Tests', () => {
    ...
    describe('AssetCategoryMgm Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(AssetCategoryMgmService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/asset-categories';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return AssetCategoryMgm', () => {
