...
describe('Service Tests', () => {
    ...
    describe('IndirectAssetMgm Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(IndirectAssetMgmService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/indirect-assets';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return IndirectAssetMgm', () => {
