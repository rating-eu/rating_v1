...
describe('Service Tests', () => {
    ...
    describe('SecurityImpactMgm Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(SecurityImpactMgmService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/security-impacts';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return SecurityImpactMgm', () => {
