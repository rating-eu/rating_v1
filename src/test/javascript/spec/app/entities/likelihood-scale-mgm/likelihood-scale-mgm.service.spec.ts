...
describe('Service Tests', () => {
    ...
    describe('LikelihoodScaleMgm Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(LikelihoodScaleMgmService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/likelihood-scales';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return LikelihoodScaleMgm', () => {
