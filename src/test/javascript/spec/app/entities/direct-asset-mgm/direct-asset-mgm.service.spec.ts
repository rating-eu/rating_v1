...
describe('Service Tests', () => {
    ...
    describe('DirectAssetMgm Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(DirectAssetMgmService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/direct-assets';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return DirectAssetMgm', () => {
