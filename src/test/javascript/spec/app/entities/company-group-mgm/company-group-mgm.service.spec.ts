...
describe('Service Tests', () => {
    ...
    describe('CompanyGroupMgm Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(CompanyGroupMgmService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/company-groups';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return CompanyGroupMgm', () => {
