...
describe('Service Tests', () => {
    ...
    describe('SelfAssessmentMgm Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(SelfAssessmentMgmService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/self-assessments';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return SelfAssessmentMgm', () => {
