...
describe('Service Tests', () => {
    ...
    describe('LevelWrapperMgm Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(LevelWrapperMgmService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/level-wrappers';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return LevelWrapperMgm', () => {
