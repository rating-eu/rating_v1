...
describe('Service Tests', () => {
    ...
    describe('PhaseWrapperMgm Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(PhaseWrapperMgmService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/phase-wrappers';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return PhaseWrapperMgm', () => {
