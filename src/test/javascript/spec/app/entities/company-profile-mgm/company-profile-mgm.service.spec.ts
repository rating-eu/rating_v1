...
describe('Service Tests', () => {
    ...
    describe('CompanyProfileMgm Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(CompanyProfileMgmService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/company-profiles';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return CompanyProfileMgm', () => {
