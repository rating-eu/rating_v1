...
describe('Service Tests', () => {
    ...
    describe('LikelihoodPositionMgm Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(LikelihoodPositionMgmService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/likelihood-positions';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return LikelihoodPositionMgm', () => {
