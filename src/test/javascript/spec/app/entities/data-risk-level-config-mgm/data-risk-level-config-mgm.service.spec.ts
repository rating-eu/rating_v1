...
describe('Service Tests', () => {
    ...
    describe('DataRiskLevelConfigMgm Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(DataRiskLevelConfigMgmService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/data-risk-level-configs';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return DataRiskLevelConfigMgm', () => {
