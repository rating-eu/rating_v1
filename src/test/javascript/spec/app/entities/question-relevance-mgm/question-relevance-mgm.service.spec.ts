...
describe('Service Tests', () => {
    ...
    describe('QuestionRelevanceMgm Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(QuestionRelevanceMgmService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/question-relevances';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return QuestionRelevanceMgm', () => {
