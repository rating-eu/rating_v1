...
describe('Service Tests', () => {
    ...
    describe('ImpactLevelDescriptionMgm Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ImpactLevelDescriptionMgmService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/impact-level-descriptions';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ImpactLevelDescriptionMgm', () => {
