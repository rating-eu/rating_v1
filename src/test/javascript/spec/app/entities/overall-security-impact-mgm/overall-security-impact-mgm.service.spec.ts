...
describe('Service Tests', () => {
    ...
    describe('OverallSecurityImpactMgm Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(OverallSecurityImpactMgmService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/overall-security-impacts';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return OverallSecurityImpactMgm', () => {
