...
describe('Service Tests', () => {
    ...
    describe('GDPRQuestionnaireStatusMgm Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(GDPRQuestionnaireStatusMgmService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/gdpr-questionnaire-statuses';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return GDPRQuestionnaireStatusMgm', () => {
