...
describe('Service Tests', () => {
    ...
    describe('DataRecipientMgm Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(DataRecipientMgmService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/data-recipients';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return DataRecipientMgm', () => {
