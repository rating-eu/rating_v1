...
describe('Service Tests', () => {
    ...
    describe('ThreatAgentMgm Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ThreatAgentMgmService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/threat-agents';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ThreatAgentMgm', () => {
