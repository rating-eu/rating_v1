...
describe('Service Tests', () => {
    ...
    describe('GDPRQuestionMgm Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(GDPRQuestionMgmService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/gdpr-questions';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return GDPRQuestionMgm', () => {
