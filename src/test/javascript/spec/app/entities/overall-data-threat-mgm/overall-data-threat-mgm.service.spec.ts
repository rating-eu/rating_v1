...
describe('Service Tests', () => {
    ...
    describe('OverallDataThreatMgm Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(OverallDataThreatMgmService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/overall-data-threats';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return OverallDataThreatMgm', () => {
