...
describe('Service Tests', () => {
    ...
    describe('GDPRQuestionnaireMgm Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(GDPRQuestionnaireMgmService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/gdpr-questionnaires';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return GDPRQuestionnaireMgm', () => {
