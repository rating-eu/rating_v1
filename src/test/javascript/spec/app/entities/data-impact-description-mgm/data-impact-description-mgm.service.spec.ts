...
describe('Service Tests', () => {
    ...
    describe('DataImpactDescriptionMgm Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(DataImpactDescriptionMgmService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/data-impact-descriptions';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return DataImpactDescriptionMgm', () => {
